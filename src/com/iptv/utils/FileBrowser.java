...
public class FileBrowser {
	...
	private static final void refreshData(File root, File now,
	...
	public static final AlertDialog createFileBrowser(Context ctx,
			final String root, final String extension,
			final OnFileSelectedListener listener) {
